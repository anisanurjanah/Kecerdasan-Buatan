...
<head>
  ...
  <title>Admin - Tambah Data Aturan</title>
...
<body>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Tambah Data Aturan</h1>
      </div>
    </div><!--/.row-->
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="kd_penyakit" id="kd_penyakit">
                    ...
                    foreach ($penyakit as $row) {
                      echo "<option value=\"" . $row["kd_penyakit"] . "\">" . $row["kd_penyakit"] . " | " . $row["nama_penyakit"] . "</option>";
                    }
                    ?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="kd_gejala" id="kd_gejala">
                    ...
                    foreach ($gejala as $row) {
                      echo "<option value=\"" . $row["kd_gejala"] . "\">" . $row["kd_gejala"] . " | " . $row["nama_gejala"] . "</option>";
                    }
                    ?>
                  </select>
                </div>
